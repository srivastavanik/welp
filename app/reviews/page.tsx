...
export default function MyReviewsPage({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-gradient-brand mx-auto mb-4" />
              ...
              >
                <Card className={cn(
                  ...
                  <CardContent className="space-y-3 pt-0 relative">
                    <p className="text-sm text-gray-700 italic leading-relaxed bg-white/50 p-3 rounded-lg">
                      "{review.comment}"
                    </p>

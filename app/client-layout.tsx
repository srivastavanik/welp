...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  // Mock user and business data
  const businessName = "The Grand Cafe"
                  ...
                  <DropdownMenuContent align="end" className="w-56">
                    <DropdownMenuLabel className="font-normal">
                      <div className="flex flex-col space-y-1">
                        ...
                        <p className="text-xs leading-none text-muted-foreground">Owner at {businessName}</p>
                      </div>
                    </DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => alert("This is a mock logout.")}>
